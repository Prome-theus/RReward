  ...
  return (
        ...
        style={{ backgroundImage: "url('/moneyrain.gif')" }}>
            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="w-24 h-24 flex items-center justify-center bg-gray-200 rounded-full mb-4 mt-6">
                    <img
                    className="w-30 h-30"
                    src="/Logo.png"
                    alt="Company Logo"
                ...
                <h1 className="text-5xl font-bold font-sans text-[#DC6B19] mb-8 text-center">
                ReviewReward Privacy Policy
                </h1>
                <div className="bg-black p-6 rounded-lg shadow-md mb-8">
                <h2
                    className="text-4xl text-[#DC6B19] font-semibold cursor-pointer flex justify-between items-center transition-colors duration-100 ease-in-out"
                    onClick={toggleUser}
                >
                ...
                >
                    <h3 className="text-3xl font-semibold text-[#DC6B19]">What data we collect:</h3>
                    <ul className="list-disc mt-2 text-xl text-[#DC6B19]">
                    ...
                    <h3 className="text-3xl font-semibold mt-4 text-[#DC6B19]">
                    How we prevent data breaches:
                    </h3>
                    <ul className="list-disc text-[#DC6B19] mt-2 text-xl">
                ...
                <div className="bg-black p-6 rounded-lg shadow-md mb-8 text-[#DC6B19]">
                <h2
                    className="text-4xl font-semibold cursor-pointer flex justify-between items-center transition-colors duration-300 ease-in-out text-[#DC6B19]"
                    onClick={toggleBrand}
                >
                ...
                >
                    <h3 className="text-3xl font-semibold text-[#DC6B19]"> Collection and Use of Personal Information:</h3>
                    <ul className="list-disc text-[#DC6B19] mt-2 text-xl">
